...
def add_isaac_arena_cli_args(parser: argparse.ArgumentParser) -> None:
    ...
    isaac_arena_group.add_argument("--scene", type=str, default=None, help="Name of the scene.")
    ...
    isaac_arena_group.add_argument("--arena_task", type=str, default=None, help="Name of the task.")
