...
class ReplayActionPolicy(PolicyBase):
    ...
    def __init__(self, replay_file_path: str, episode_name: str | None = None):
        ...
        self.episode_data = self.dataset_file_handler.load_episode(self.episode_name, device="cuda")
