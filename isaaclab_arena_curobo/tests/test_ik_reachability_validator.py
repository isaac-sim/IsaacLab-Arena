...
def _make_reachability_validator(embodiment, monkeypatch=None, visualizer=None):
    ...
    ``visualizer`` stands in for the placement debug view ObjectPlacer would have created, which the
    check looks up in the visualizer module instead of receiving through its params.
    """
