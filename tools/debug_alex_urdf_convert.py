...
parser.add_argument("--urdf", default="/models/alex_V1_description/urdf/alex_v1.miniFullBodyNubForearms.urdf")
...
abs_prefix = os.path.join(args.models_dir, "alex_V1_description") + "/"
...
try:
    ...
    usd_dir = "/tmp/alex_debug_full"
    usdex_path = os.path.join(usd_dir, "usdex")
    intermediate_path = os.path.join(usd_dir, "temp", "alex_v1_normalized.usd")
    ...
    output_root = os.path.join(usd_dir, "alex_v1_normalized")
    ...
    final_usd = os.path.join(output_root, "alex_v1_normalized.usda")
