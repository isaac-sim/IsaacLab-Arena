...
from isaaclab_arena.arena_gr00t.policy_config import Gr00tClosedloopPolicyConfig, TaskMode
from isaaclab_arena.policy.data_utils.image_conversion import resize_frames_with_padding
from isaaclab_arena.policy.data_utils.io_utils import create_config_from_yaml, load_robot_joints_config_from_yaml
from isaaclab_arena.policy.data_utils.joints_conversion import (
    remap_policy_joints_to_sim_joints,
    remap_sim_joints_to_policy_joints,
)
from isaaclab_arena.policy.data_utils.robot_joints import JointsAbsPosition
...
class Gr00tClosedloopPolicy(PolicyBase):
    ...
    def load_policy(self) -> Gr00tPolicy:
        ...
        if self.policy_config.data_config in DATA_CONFIG_MAP:
            ...
            self.data_config = load_data_config("isaaclab_arena.arena_gr00t.data_config:UnitreeG1SimWBCDataConfig")
        else:
