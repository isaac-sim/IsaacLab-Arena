...
def _serve() -> int:
    ...
    from isaaclab_arena.environments.arena_env_graph_spec import UnresolvedArenaEnvGraphSpec  # noqa: PLC0415
    ...
    try:
        for raw_line in sys.stdin:
            ...
            if cmd == "render_spec":
                _send(_handle_render_spec(app, req, _render_thumbnails_with_app, UnresolvedArenaEnvGraphSpec))
                continue
