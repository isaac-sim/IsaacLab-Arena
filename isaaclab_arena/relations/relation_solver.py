...
class RelationSolver:
    ...
    def __init__(
        ...
        self._mesh_orientations: list[dict[PlacementAsset, float]] | None = None
    ...
    def solve(
        ...
        env_bboxes: dict[PlacementAsset, AxisAlignedBoundingBox] | None = None,
        env_bboxes_include_yaw: bool = False,
        orientations: list[dict[PlacementAsset, float]] | None = None,
        collision_objects: list[CollisionObject] | None = None,
    ) -> list[dict[PlacementAsset, tuple[float, float, float]]]:
    ...
    def debug_losses(self, objects: list[PlacementAsset]) -> None:
