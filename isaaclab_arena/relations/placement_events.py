...
def get_placement_pool(env) -> PooledObjectPlacer | None:
    ...
    The pool is stored on the env (not in the reset event params) because mesh collision
    caches hold GPU/ctypes handles that cannot be deep-copied by configclass.
...
def solve_and_place_objects(
    ...
    Args:
        ...
        placement_pool: Runtime pool of solved placement layouts. When omitted, read from the env.
    """
