...
class NextTo(Relation):
    ...
    def __init__(
        ...
        Args:
            ...
            alignment: Where to place the child along the parent's perpendicular
                extent, from -1.0 (min edge) through 0.0 (centered) to 1.0 (max edge).
                The perpendicular axis depends on the side: for POSITIVE_X / NEGATIVE_X
                the perpendicular axis is Y; for POSITIVE_Y / NEGATIVE_Y it is X.
        ...
        assert -1.0 <= alignment <= 1.0, f"alignment must be in [-1, 1], got {alignment}"
