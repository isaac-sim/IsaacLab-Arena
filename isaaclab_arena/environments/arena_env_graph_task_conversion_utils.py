...
def _build_task_from_spec(task_spec: ArenaEnvGraphTaskSpec, assets_by_node_id: dict[str, Any]) -> Any:
    ...
    task_class = TaskRegistry().get_task_by_name(task_spec.task.kind)
    task_init_kwargs = _resolve_node_refs_in_task_args(task_class, task_spec.task.params, assets_by_node_id)
