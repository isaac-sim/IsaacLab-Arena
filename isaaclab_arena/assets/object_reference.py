...
class ObjectReference(ObjectBase):
    ...
    def isaaclab_prim_path_to_original_prim_path(
        ...
        assert original_prim_path.startswith(parent_asset.name), "Expected the prim path to start with the parent asset name {parent_asset.name}. Instead got {original_prim_path}"
