...
INDUSTRIAL_TOOL_SORT_ASSET_DIR: str = (
    "omniverse://isaac-dev.ov.nvidia.com/Projects/nvblox/isaac_arena/newton_envs/industrial_tool_sort"
)
"""Private industrial tool-sort asset root pending publication to Arena's public asset location."""
