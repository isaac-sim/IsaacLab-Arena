...
def test_mouse_interaction_uses_d6_grab_for_current_stage():
    # Runs in its own process: enabling the `omni.physx.ui` extension mutates global Kit
    # state that cannot be undone on the shared persistent SimulationApp and perturbs later
    # tests' physics.
