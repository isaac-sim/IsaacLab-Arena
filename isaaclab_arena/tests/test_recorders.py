...
def test_end_effector_poses_term_uses_the_given_names():
    terms_cfg = make_trajectory_recorder_terms_cfg(frame_transformer_name="left_ee_frame", asset_name="left_arm")

    assert terms_cfg.record_end_effector_poses.frame_transformer_name == "left_ee_frame"
    assert terms_cfg.record_end_effector_poses.asset_name == "left_arm"
