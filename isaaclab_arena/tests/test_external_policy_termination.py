...
def _test_external_policy_termination_contract(_simulation_app):
    ...
    original_snapshot = IsaacLabArenaManagerBasedRLEnv._snapshot_initial_object_poses
    try:
        ...
        IsaacLabArenaManagerBasedRLEnv._snapshot_initial_object_poses = lambda self, env_ids: None
        ...
        IsaacLabArenaManagerBasedRLEnv._snapshot_initial_object_poses = original_snapshot
