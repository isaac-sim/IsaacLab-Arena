...
def _test_pass(simulation_app) -> bool:
    return True
...
def _test_fail(simulation_app) -> bool:
    return False
...
def test_pass():
    ...
    assert result, f"Test {_test_pass.__name__} failed"
...
def test_fail():
    ...
    assert result, f"Test {_test_fail.__name__} failed"

def test_fail_in_main_process():
    assert False

if __name__ == "__main__":
    test_fail_in_main_process()
    test_pass()
    test_fail()
