...
def _test_extract_trimesh_from_prim_rejects_mixed_unsupported_geometry(simulation_app):
    """Reject incomplete mesh coverage of mixed geometry."""
    from pxr import Gf, Usd, UsdGeom
...
def _test_extract_trimesh_from_usd_rejects_mixed_unsupported_geometry(simulation_app):
    """Reject incomplete mesh coverage from a USD file."""
    from pxr import Gf, Usd, UsdGeom
...
def test_extract_trimesh_from_prim_rejects_mixed_unsupported_geometry():
    result = run_function_with_persistent_simulation_app(
        _test_extract_trimesh_from_prim_rejects_mixed_unsupported_geometry, headless=HEADLESS
    )
    assert result
...
def test_extract_trimesh_from_usd_rejects_mixed_unsupported_geometry():
    result = run_function_with_persistent_simulation_app(
        _test_extract_trimesh_from_usd_rejects_mixed_unsupported_geometry, headless=HEADLESS
    )
    assert result
