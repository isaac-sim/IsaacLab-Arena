...
# arena_experiment_runner, and the remaining argparse scripts pass ArenaEnvBuilderCfg directly.
...
# policy_runner, arena_experiment_runner, and the remaining argparse scripts accept typed configs.
