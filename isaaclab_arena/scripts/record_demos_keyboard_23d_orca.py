...
def main() -> None:
    ...
    try:
        ...
        #     print(f"   Position (world): X={cart_pos[0]:.4f}, Y={cart_pos[1]:.4f}, Z={cart_pos[2]:.4f}")
        #     print(f"   Position (relative): X={cart_pos_rel[0]:.4f}, Y={cart_pos_rel[1]:.4f}, Z={cart_pos_rel[2]:.4f}")
        #     print(f"   Bounding Box Size: {bbox_info}")
                        ...
                        if success_term is not None:
                            try:
                                ...
                                if object_z < -0.6:
                                    ...
                                    print(f"   ⚠️  Other termination condition")
                            except:
                                print(f"   ⚠️  Termination condition triggered")
                        else:
                            print(f"   ⚠️  Termination condition triggered")
                    elif env.reset_time_outs[0]:
                        print(f"\n⏱️  Episode Timeout Reached")
