...
# pxr is imported inside each function that needs it, so importing this module stays safe during
# pytest collection: a pxr import before SimulationApp starts breaks the simulation tests.
