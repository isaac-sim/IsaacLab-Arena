...
class AllCollisionMeshesExcludedError(NoCollisionMeshError):
    """Every collision mesh is under an excluded USD subtree."""
...
def extract_trimesh_from_usd(
    ...
    if excluded_mesh_count and not included_mesh_count:
        raise AllCollisionMeshesExcludedError(f"All mesh geometry excluded from {usd_path}")
