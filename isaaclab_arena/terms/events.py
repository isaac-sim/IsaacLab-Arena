...
"""Event terms for Arena: object pose (single/batched) and placement layouts at reset."""
...
class PlacementEventsCfg:
    """Event config for applying relation placement layouts at reset (one layout per env)."""
