...
def create_policy(args: argparse.Namespace) -> tuple[PolicyBase, int]:
    ...
    if args.policy_type == "replay":
        ...
        from isaaclab_arena.arena_gr00t.replay_lerobot_action_policy import ReplayLerobotActionPolicy
        ...
        from isaaclab_arena.arena_gr00t.gr00t_closedloop_policy import Gr00tClosedloopPolicy
