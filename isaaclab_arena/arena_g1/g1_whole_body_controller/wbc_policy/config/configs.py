...
class HomieV2Config(BaseConfig):
    ...
    wbc_model_path: str = (
        "omniverse://isaac-dev.ov.nvidia.com/Projects/nvblox/isaaclab_arena/g1_locomanip_assets/wbc_policy/models/homie_v2/stand.onnx,omniverse://isaac-dev.ov.nvidia.com/Projects/nvblox/isaaclab_arena/g1_locomanip_assets/wbc_policy/models/homie_v2/walk.onnx"
    )
    """Path to WBC model file"""
