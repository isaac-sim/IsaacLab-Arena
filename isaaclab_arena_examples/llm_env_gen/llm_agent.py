...
class LLMAgent:
    ...
    def _system_prompt(self) -> str:
        ...
        return (
            ...
            "- relation.phase ∈ {initial, goal}:\n"
            "    * initial — configures the starting scene (object spawn locations).\n"
            "    * goal    — the task's success condition; must NOT affect initial placement.\n"
            "  A 'place A into B' prompt should emit TWO relations for A: an initial `on` of the\n"
            "  support surface (e.g. table) and a goal `in` of the container (e.g. bowl).\n"
