...
Examples:
    ...
    /isaac-sim/python.sh isaaclab_arena_examples/agentic_environment_generation/try_environment_intent_schema.py --print-schema

    # Print the catalog sent to the agent (no agent call):
    /isaac-sim/python.sh isaaclab_arena_examples/agentic_environment_generation/try_environment_intent_schema.py --print-catalog

    # Call the agent, compile, print, and dump YAML:
    /isaac-sim/python.sh isaaclab_arena_examples/agentic_environment_generation/try_environment_intent_schema.py \
