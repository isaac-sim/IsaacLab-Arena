...
class SingleBallEnvironment(ExampleEnvironmentBase):
    """Single dynamic ball environment with one camera for data generation."""

    scene_metadata = make_reference_metadata("single_ball", num_objects=1)
    ...
    def get_env(self, _args_cli: argparse.Namespace) -> Any:
        ...
        scene = Scene(assets=[dynamic_object, light, distant_light])
    ...
    def add_cli_args(parser: argparse.ArgumentParser) -> None:
        """Add single-ball-specific CLI arguments to the parser."""
