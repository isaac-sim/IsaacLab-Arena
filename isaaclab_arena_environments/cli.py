...
from isaaclab_arena_environments.franka_articulation_environment import FrankaPutAndCloseContainerEnvironment
...
ExampleEnvironments = {
    FrankaPutAndCloseContainerEnvironment.name: FrankaPutAndCloseContainerEnvironment,
