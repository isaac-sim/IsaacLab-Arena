...
from isaaclab_arena_environments.gr1_rotate_stand_mixer_knob_environment import Gr1RotateStandMixerKnobEnvironment
...
ExampleEnvironments = {
    ...
    Gr1RotateStandMixerKnobEnvironment.name: Gr1RotateStandMixerKnobEnvironment,
}
