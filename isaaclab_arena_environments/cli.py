...
from isaaclab_arena_environments.srl_pick_and_place_environment import SrlPickAndPlaceEnvironment
...
ExampleEnvironments = {
    ...
    SrlPickAndPlaceEnvironment.name: SrlPickAndPlaceEnvironment,
