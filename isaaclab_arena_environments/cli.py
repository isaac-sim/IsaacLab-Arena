...
from isaaclab_arena_environments.gr1_open_microwave_rl_environment import Gr1OpenMicrowaveRlEnvironment
...
ExampleEnvironments = {
    ...
    Gr1OpenMicrowaveRlEnvironment.name: Gr1OpenMicrowaveRlEnvironment,
