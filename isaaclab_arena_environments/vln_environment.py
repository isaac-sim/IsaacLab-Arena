...
class VLNBenchmarkEnvironment(ExampleEnvironmentBase):
    ...
    def get_env(self, args_cli: argparse.Namespace):
        ...
        background = MatterportBackground(
            ...
            floor_collision_usd_path=getattr(args_cli, "matterport_floor_collision_usd_path", None),
            obstacle_collision_usd_path=getattr(args_cli, "matterport_obstacle_collision_usd_path", None),
        )
    ...
    def add_cli_args(parser: argparse.ArgumentParser) -> None:
        ...
        group.add_argument(
            ...
            type=str,
            default=None,
            help="Legacy combined collision-only USD layered under the visual Matterport scene.",
        )
        group.add_argument(
            "--matterport_floor_collision_usd_path",
            type=str,
            default=None,
            help="Optional floor-only collision USD layered under the visual Matterport scene.",
        )
        group.add_argument(
            "--matterport_obstacle_collision_usd_path",
            type=str,
            default=None,
            help="Optional obstacle-only collision USD layered under the visual Matterport scene.",
        )
        group.add_argument(
