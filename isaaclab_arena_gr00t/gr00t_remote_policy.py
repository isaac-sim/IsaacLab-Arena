...
class Gr00tRemoteModelPolicy(ModelPolicy):
    ...
    def __init__(self, policy_config_yaml_path: Path) -> None:
        ...
        print("[Gr00tRemoteModelPolicy] Gr00tPolicy loaded successfully")

    def _load_gr00t_policy(self) -> Gr00tPolicy:
        print(f"[Gr00tRemoteModelPolicy] loading data_config={self._cfg.data_config}")
        ...
        print(f"[Gr00tRemoteModelPolicy] loading checkpoint from: {model_path}")
    ...
    def get_action(
        ...
        print("[Gr00tRemoteModelPolicy] get_action called")
        ...
        print("[Gr00tRemoteModelPolicy] get_action done")
        return action, info

    def reset(self, options: Dict[str, Any] | None = None) -> Dict[str, Any]:
        print(f"[Gr00tRemoteModelPolicy] reset called: options={options}")
