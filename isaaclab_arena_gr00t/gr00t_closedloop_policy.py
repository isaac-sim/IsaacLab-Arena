...
class Gr00tClosedloopPolicy(PolicyBase):
    def __init__(self, policy_config_yaml_path: Path, num_envs: int = 1, device: str = "cuda", *, policy_deployment: str = "local", remote_config: Optional[RemotePolicyConfig] = None):
        """
    ...
    def load_local_policy(self):
        try:
            ...
            raise ImportError(
                ...
                "Install gr00t packages or use policy_deployment='remote'."
            ) from exc
