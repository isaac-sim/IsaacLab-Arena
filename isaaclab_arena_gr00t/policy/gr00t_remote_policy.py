...
from isaaclab_arena.remote_policy.remote_policy_config import ClientPolicyConfig
...
class Gr00tRemoteServerSidePolicy(ServerSidePolicy):
    ...
    def _unpack_observation(self, flat_obs: Dict[str, Any]) -> Dict[str, Any]:
        nested: Dict[str, Any] = {}
    ...
    def _build_policy_observations(
        ...
        observation = self._unpack_observation(observation)
    ...
    def get_action(
        ...
        action: Dict[str, Any] = {"action_chunk": action_chunk}
        info: Dict[str, Any] = {}
        return action, info
