...
* - **Post-training**
  - Imitation Learning
* - **Dataset**
  - [Arena-G1-Static-PickNPlace-Task](https://huggingface.co/datasets/nvidia/Arena-G1-Static-PickNPlace-Task)
* - **Checkpoint**
  - [GN1x-Tuned-Arena-G1-Static-PickNPlace](https://huggingface.co/nvidia/GN1x-Tuned-Arena-G1-Static-PickNPlace)
* - **Physics**
...
[GR00T installation guide](https://github.com/NVIDIA/Isaac-GR00T/blob/4b1dca9d88d2a0b9ea5a65aa61c82ff89f5c4f0e/README.md#installation-guide).
