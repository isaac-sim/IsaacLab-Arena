...
You may want to review or edit the spec before building the environment. Agent resolves the spec based on the prompt using a LLM model, and may be mistaken in its choices.
