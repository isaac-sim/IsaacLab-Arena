...
.. figure:: ../../../../images/agentic_environment_generation/tabletop_agentic_env_cans_simready.png
   ...
   The generated table-top scene: a DROID arm, a beverage soda can, a tuna can, a mini plastic basket, a hammer and a
   bean can. The task is to pick up the beverage soda can and bean can from the maple table and place them into the
   mini plastic basket.
