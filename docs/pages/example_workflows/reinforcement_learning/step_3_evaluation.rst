...
3. **Batch evaluation** (``arena_experiment_runner.py``): automated evaluation across multiple checkpoints
...
To evaluate multiple checkpoints in sequence, use ``arena_experiment_runner.py`` with a JSON config.
